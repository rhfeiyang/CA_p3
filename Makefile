...
LIBS = -lm -fopenmp -march=native -mtune=native -fipa-cp-clone -fipa-sra -fipa-pta -pipe -flto -funroll-loops -floop-strip-mine -ftree-vectorize -floop-interchange -fomit-frame-pointer
